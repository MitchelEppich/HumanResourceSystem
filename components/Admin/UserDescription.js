        ...
        <div style={{
            ...
            className="inline-flex w-full bg-grey-new relative">
                ...
                <div className="w-full">
                    <h3 className="p-2 text-center text-white uppercase">User Description</h3>
                </div>                
            </div>
            {/* <div className="inline-flex w-full bg-orange-new text-white p-1">
                <div className="w-full uppercase text-sm">Please, insert here all information</div>
            ...
            <div className="inline-flex w-full bg-grey-lighter text-grey p-1 mt-2 flex items-center">
                ...
                <div className="w-full bg-grey-lighter p-1 py-2 mt-2 inline-flex flex items-top">
                    ...
                    <div><textarea cols="80" rows="6" className="pt-2 pl-2" placeholder="Optional"/></div>
                </div>
                <div className="w-full bg-grey-lighter p-1 py-2 mt-2 inline-flex flex items-top">
                    <div className="mt-2">
                    ...
                    <div>
                        <textarea cols="80" rows="6" className="ml-6 pt-2 pl-2" placeholder="Add here your notes..." />
                    </div>
                    <div className="w-10 h-10 flex items-center">
                                <FontAwesomeIcon
                                onClick={() => {
