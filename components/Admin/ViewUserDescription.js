        ...
        className="w-newScreen align-absolute bg-white text-center pin-auto">
            ...
            className="inline-flex w-full bg-grey-new relative">
                ...
                <div className="w-full">
                    <h3 className="p-2 text-center text-white uppercase">View User        Description
                    </h3>
                </div> 
                ...
                <div className="inline-flex w-full bg-grey-lighter py-2 text-grey p-1 mt-4 flex items-center">
                    <div className="w-2/4 uppercase">
                        <div className="w-full pl-6 text-left inline-flex flex items-center">
                            ...
                            <div className="w-300">
                                <p className="p-2">Mitchel Musso</p>
                            </div>
                        </div>                    
                    </div>
                    <div className="w-2/4 uppercase">
                ...
                <div className="w-full mt-2 p-1 pb-2 bg-grey-lighter">
                    <div className="w-full pl-6 mt-2 inline-flex flex items-center">
                        ...
                        <div className="w-300 inline-flex flex items-center">
                            <p className="p-2 uppercase">Senior Web Developer</p>   
                        </div>
                    </div>
            ...
            <div className="inline-flex w-full bg-grey-lighter text-grey p-1 mt-2 flex items-center">
                    <div className="w-2/4 uppercase pt-2 pb-2">
                        <div className="w-full pl-6 text-left inline-flex flex items-center">
                            ...
                            <div className="w-300">
                                <p className="p-2 uppercase">02/06/2018</p> 
                            </div>
                        </div>                    
                        <div className="w-full pl-6 text-left mt-4 inline-flex flex items-center">
                            ...
                            <div className="w-300">
                                <p className="p-2 uppercase">03/06/2018</p>
                            </div>
                        </div>                    
                    </div>
                    <div className="w-2/4 uppercase">
                        <div className="w-full pl-6 text-left inline-flex flex items-center">
                            ...
                            <div className="w-300">
                                <p className="p-2 uppercase">(236) 800 4444</p>
                            </div>
                        </div>                    
                        <div className="w-full pl-6 text-left mt-4 inline-flex flex items-center">
                            <div style={{width: "100px"}} className="text-left">
                            ...
                            <div className="w-300">
                                <p className="p-2 uppercase">mitchel.work@gmail.com</p>
                            </div>
                        </div> 
                    </div>
                ...
                <div className="w-full bg-grey-lighter p-1 py-2 mt-2 inline-flex flex items-top">
                    <div style={{width: "160px"}} className="text-left mt-2"><label className="font-bold pl-5 pr-2 uppercase">Job Description:</label></div>
                    <p className="p-2 uppercase text-left w-750">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat.</p>
                </div>
                <div className="w-full bg-grey-lighter p-1 py-2 mt-2 inline-flex flex items-top">
                    <div style={{width: "160px"}} className="text-left mt-2"><label className="font-bold pl-5 pr-3 pr-2 uppercase">Admin Notes:</label></div>
                    <p className="p-2 uppercase text-left w-750">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat.</p>
                </div>
        </div>
    </div>
