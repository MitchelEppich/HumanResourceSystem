    ...
    for (let _client in props.misc.clientSystems) {
      ...
      arr.push(
        <div className="mt-2 inline-flex w-full bg-grey-light text-grey p-1 flex items-center">
          ...
          <div className="w-10 h-10 p-1 text-center text-grey justify-center mx-auto align-center cursor-pointer hover:bg-semi-transparent hover:text-grey-new" onClick={() => {
  ...
  return (
    ...
    >
      ...
      <div className="inline-flex w-full bg-orange-new text-white p-1">
        ...
        <div className="w-1/5 uppercase text-sm">Locked</div>
